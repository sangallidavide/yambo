...
PETSC_EXTERN void PETSC_STDCALL  matfactorcreateschurcomplement_(Mat F,Mat* S, int *__ierr ){
*__ierr = MatFactorCreateSchurComplement(
	(Mat)PetscToPointer((F) ),S);
}
PETSC_EXTERN void PETSC_STDCALL  matfactorgetschurcomplement_(Mat F,Mat* S, int *__ierr ){
*__ierr = MatFactorGetSchurComplement(
	(Mat)PetscToPointer((F) ),S);
}
PETSC_EXTERN void PETSC_STDCALL  matfactorrestoreschurcomplement_(Mat F,Mat* S, int *__ierr ){
