...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define kspchebyshevesteigsetuserandom_ KSPCHEBYSHEVESTEIGSETUSERANDOM
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define kspchebyshevesteigsetuserandom_ kspchebyshevesteigsetuserandom
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void PETSC_STDCALL  kspchebyshevesteigsetuserandom_(KSP ksp,PetscBool *use, int *__ierr ){
*__ierr = KSPChebyshevEstEigSetUseRandom(
