...
PETSC_EXTERN void PETSC_STDCALL  dmnetworkmonitoradd_(DMNetworkMonitor *monitor, char *name,PetscInt *element,PetscInt *nodes,PetscInt *start,PetscInt *blocksize,PetscReal *ymin,PetscReal *ymax,PetscBool *hold, int *__ierr ){
*__ierr = DMNetworkMonitorAdd(*monitor,name,*element,*nodes,*start,*blocksize,*ymin,*ymax,*hold);
}
