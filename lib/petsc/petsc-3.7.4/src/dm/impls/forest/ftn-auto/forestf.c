...
PETSC_EXTERN void PETSC_STDCALL  dmforestsetadaptivitypurpose_(DM dm,DMForestAdaptivityPurpose *purpose, int *__ierr ){
*__ierr = DMForestSetAdaptivityPurpose(
	(DM)PetscToPointer((dm) ),*purpose);
}
PETSC_EXTERN void PETSC_STDCALL  dmforestgetadaptivitypurpose_(DM dm,DMForestAdaptivityPurpose *purpose, int *__ierr ){
*__ierr = DMForestGetAdaptivityPurpose(
	(DM)PetscToPointer((dm) ),
	(DMForestAdaptivityPurpose* )PetscToPointer((purpose) ));
}
