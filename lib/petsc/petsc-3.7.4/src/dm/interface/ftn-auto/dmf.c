...
PETSC_EXTERN void PETSC_STDCALL  dmlocalizecoordinate_(DM dm, PetscScalar in[],PetscScalar out[], int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  dmlocatepoints_(DM dm,Vec v,PetscSF *cellSF, int *__ierr ){
*__ierr = DMLocatePoints(
	(DM)PetscToPointer((dm) ),
	(Vec)PetscToPointer((v) ),cellSF);
}
