...
#define tsalpha2useadapt_ TSALPHA2USEADAPT
...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  tsalpha2useadapt_(TS ts,PetscBool *use, int *__ierr ){
*__ierr = TSAlpha2UseAdapt(
	(TS)PetscToPointer((ts) ),*use);
}
