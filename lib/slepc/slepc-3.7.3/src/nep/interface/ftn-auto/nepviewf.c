...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  nepreasonviewfromoptions_(NEP nep, int *__ierr ){
*__ierr = NEPReasonViewFromOptions(
	(NEP)PetscToPointer((nep) ));
}
PETSC_EXTERN void PETSC_STDCALL  neperrorviewfromoptions_(NEP nep, int *__ierr ){
*__ierr = NEPErrorViewFromOptions(
	(NEP)PetscToPointer((nep) ));
}
PETSC_EXTERN void PETSC_STDCALL  nepvaluesviewfromoptions_(NEP nep, int *__ierr ){
*__ierr = NEPValuesViewFromOptions(
	(NEP)PetscToPointer((nep) ));
}
PETSC_EXTERN void PETSC_STDCALL  nepvectorsviewfromoptions_(NEP nep, int *__ierr ){
