 ...
 *i_opt=*i_opt+1;
 ...
 options[*i_opt].section="Real-Time";
 options[*i_opt].long_desc[0]="<string>=(X)response,(a)bsorption,arpe(s),(o)ccupations,(l)ifetimes,(d)ensity,(p)olariazion,(g)reenfunction";
 ...
 *i_opt=*i_opt+1;
 ...
 options[*i_opt].long_desc[3]="rtplot=s/d => <string>=(t)ime";
