 ...
 *i_opt=*i_opt+1;
 ...
 options[*i_opt].section="Real-Time";
 strcpy(options[*i_opt].long_desc[0],"<string>=(X)response,(a)bsorption,(o)ccupations,(l)ifetimes,(d)ensity,(p)olariazion,(f)ields,(g)reen-function");
 ...
 strcpy(options[*i_opt].long_desc[5],"(f) generate and manupulate fields file");
 strcpy(options[*i_opt].long_desc[6],"(g) evaluates the two-times Green`s function");
 *i_opt=*i_opt+1;
