...
#if defined _ELPH  
 strcpy(options[*i_opt].long_desc[0],"<string>=(w)ave,(d)ensity,(m)ag,do(s),(b)ands,(c)urrent,(g)roup_symm,(e)lias");
#elif defined _YPP_MAGNETIC 
 strcpy(options[*i_opt].long_desc[0],"<string>=(w)ave,(d)ensity,(m)ag,do(s),(b)ands,(c)urrent,(g)roup_symm,angu(l)ar,(p)osition");
#else
 strcpy(options[*i_opt].long_desc[0],"<string>=(w)ave,(d)ensity,(m)ag,do(s),(b)ands,(c)urrent,(g)roup_symm");
#endif
...
#else
 strcpy(options[*i_opt].long_desc[0],"<string>=(s)ort,(l)ifetimes,(sp)in,(g)roup_symm,(a)mplitude,(w)ave,(i)nterpolate");
#endif
 ...
 *i_opt=*i_opt+1;
 ...
 strcpy(options[*i_opt].long_desc[3],"rtplot=s/d => <string>=(t)ime");
